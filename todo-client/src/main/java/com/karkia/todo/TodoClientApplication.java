package com.karkia.todo;

import com.karkia.todo.domain.ToDo;
import com.karkia.todo.service.ToDoRestClient;
import lombok.val;
import lombok.var;
...
/**
 * First, turn off the web environment with WebApplicationType.NONE.
 * Then use CommandLineRunner (as bean) to execute the code before the app starts.
 */
